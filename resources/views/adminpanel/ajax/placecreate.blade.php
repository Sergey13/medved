...
<div class="col-md-6 col-md-offset-3">
    ...
    <h3 class="page-title text-center">
        Добавление нового места установки оборудования
    </h3>

    <div class='row col-sm-12'>
        {!! Form::open(array('url' => '/places/save', 'method' => 'post', 'id' => 'form-place-add', 'class' => 'form ajax-form'))!!}
        <div class='form-group'>
            <label class="control-label" for='place-name'>Название</label>
            {!! Form::text('place[name]', '', array('class' => 'form-control', 'id' => 'place-name')) !!}
        </div>
